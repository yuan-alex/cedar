-- CreateEnum
CREATE TYPE "public"."ChatMessageRole" AS ENUM ('developer', 'assistant', 'user');

-- CreateEnum
CREATE TYPE "public"."ChatMessageStatus" AS ENUM ('inProgress', 'completed', 'failed');
...
CREATE TABLE "public"."Thread" (
    ...
    "uiMessages" JSONB[] DEFAULT ARRAY[]::JSONB[],
...
CREATE TABLE "public"."ChatMessage" (
    ...
    "isDeleted" BOOLEAN NOT NULL DEFAULT false,
    "uiMessageParts" JSONB[] DEFAULT ARRAY[]::JSONB[],
    "rawEvent" JSONB,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- CreateIndex
CREATE UNIQUE INDEX "Thread_token_key" ON "public"."Thread"("token");
